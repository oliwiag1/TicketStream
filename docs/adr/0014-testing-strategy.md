...
| **Decyzja** | Łączymy testy jednostkowe, integracyjne, scenariuszowe (end-to-end) i obciążeniowe, aby pokryć logikę krytyczną i zachowanie pod obciążeniem; w CI walidujemy skrypt obciążeniowy, a pełne testy obciążeniowe uruchamiamy manualnie przed release lub po zmianach wydajnościowych. |
